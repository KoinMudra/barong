...
| `barong_sms_content_template` | Your verification code for KoinMudra: `{{code}}` | any string value containing `{{code}}` | template, used in both configurations as content for SMS |
